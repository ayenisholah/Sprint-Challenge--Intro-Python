...
c = [name.name for name in humans if name.name.startswith(
    ('C', 'D', 'E', 'F', 'G'))]
print(c)
...
f = [(name.name, name.age) for name in humans if (name.age in range(27, 33))]
print(f)
...
# [Human("ALICE", 34), Human("BOB", 37), Human("CHARLIE", 42), Human("DAPHNE", 35), Human("EVE", 31)
